...
<html><head><title>수강신청 입력</title></head></html>
<body>
...
<%
	...
	//mySQL = "select c_id, c_id_no, c_name, c_unit from course2 where c_id not in (select c_id from enroll2 where s_id='" + session_id + "')";
	mySQL = "select c_id, c_id_no, c_name, c_unit from course2";
